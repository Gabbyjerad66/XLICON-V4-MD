...
global.botname = process.env.BOT_NAME || 'Gabby-MD';

global.ownernumber = [process.env.OWNER_NUMBER || '254112842772'];
...
global.wm = process.env.WATERMARK || "Gabby Bot Inc.";

global.botscript = process.env.SCRIPT_LINK || 'https://github.com/salmanyt4-MD';

global.packname = process.env.PACK_NAME || "Gabby";

global.author = process.env.AUTHOR_NAME || "MΛDΣ BY Gabby";

global.creator = process.env.CREATOR_NUMBER || "254112842772@s.whatsapp.net";


//~~~~~~~~~~~~~<Bot Settings>~~~~~~~~~~~~~~~\\
global.xprefix = process.env.PREFIX || ',';

global.premium = [process.env.PREMIUM_NUMBER || '254112842772'];
